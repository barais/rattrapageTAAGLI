...
import { ImagePropertyComponent } from 'app/entities/image-property/image-property.component';
...
describe('Component Tests', () => {
  describe('ImageProperty Management Component', () => {
    let comp: ImagePropertyComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ImagePropertyComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.imageProperties[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
