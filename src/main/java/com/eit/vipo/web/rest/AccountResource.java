...
import com.eit.vipo.domain.PersistentToken;
import com.eit.vipo.repository.PersistentTokenRepository;
import com.eit.vipo.domain.User;
import com.eit.vipo.repository.UserRepository;
import com.eit.vipo.security.SecurityUtils;
import com.eit.vipo.service.MailService;
import com.eit.vipo.service.UserService;
import com.eit.vipo.service.dto.PasswordChangeDTO;
import com.eit.vipo.service.dto.UserDTO;
import com.eit.vipo.web.rest.errors.*;
import com.eit.vipo.web.rest.vm.KeyAndPasswordVM;
import com.eit.vipo.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public UserDTO getAccount() {
        log.debug(userService.getUserWithAuthorities().get().getFirstName());
     ...
     * @throws RuntimeException {@code 500 (Internal Server Error)} if the current
    ...
    /**
     * {@code DELETE /account/sessions?series={series}} : invalidate an existing
     * session.
     *
